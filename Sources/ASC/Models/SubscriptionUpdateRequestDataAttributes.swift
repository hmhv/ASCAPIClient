...
public struct SubscriptionUpdateRequestDataAttributes: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(name: String? = nil, familySharable: Bool? = nil, subscriptionPeriod: SubscriptionPeriod? = nil, reviewNote: String? = nil, groupLevel: Int? = nil) {
        self.name = name
