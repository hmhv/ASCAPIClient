...
public struct CiBuildAction: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: CiBuildActionAttributes? = nil, relationships: CiBuildActionRelationships? = nil, links: ResourceLinks? = nil) {
        self.type = type
        self.id = id
