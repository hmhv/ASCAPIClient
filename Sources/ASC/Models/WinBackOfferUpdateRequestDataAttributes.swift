...
public struct WinBackOfferUpdateRequestDataAttributes: Codable, JSONEncodable, Hashable {
    ...
    public enum PromotionIntent: String, Codable, CaseIterable, CaseIterableDefaultsLast {
