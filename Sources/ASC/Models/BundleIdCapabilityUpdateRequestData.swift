...
public struct BundleIdCapabilityUpdateRequestData: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: BundleIdCapabilityAttributes? = nil) {
        self.type = type
        self.id = id
