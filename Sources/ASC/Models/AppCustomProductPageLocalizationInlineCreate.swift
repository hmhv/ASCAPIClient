...
public struct AppCustomProductPageLocalizationInlineCreate: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String? = nil, attributes: AppCustomProductPageLocalizationInlineCreateAttributes, relationships: AppCustomProductPageLocalizationInlineCreateRelationships? = nil) {
        self.type = type
        self.id = id
