...
public struct PromotedPurchaseRelationshipsPromotionImages: Codable, JSONEncodable, Hashable {
    ...
    public init(links: AppCategoryRelationshipsSubcategoriesLinks? = nil, meta: PagingInformation? = nil, data: [PromotedPurchaseRelationshipsPromotionImagesDataInner]? = nil) {
        self.links = links
        self.meta = meta
        self.data = data
    }
