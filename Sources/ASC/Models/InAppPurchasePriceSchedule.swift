...
public struct InAppPurchasePriceSchedule: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, relationships: InAppPurchasePriceScheduleRelationships? = nil, links: ResourceLinks? = nil) {
        self.type = type
        self.id = id
