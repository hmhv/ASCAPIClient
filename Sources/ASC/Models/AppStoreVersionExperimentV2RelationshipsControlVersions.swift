...
public struct AppStoreVersionExperimentV2RelationshipsControlVersions: Codable, JSONEncodable, Hashable {
    ...
    public init(links: AlternativeDistributionPackageVersionRelationshipsVariantsLinks? = nil, meta: PagingInformation? = nil, data: [AlternativeDistributionPackageCreateRequestDataRelationshipsAppStoreVersionData]? = nil) {
        self.links = links
        self.meta = meta
        self.data = data
    }
