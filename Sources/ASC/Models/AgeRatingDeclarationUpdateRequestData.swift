...
public struct AgeRatingDeclarationUpdateRequestData: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: AgeRatingDeclarationAttributes? = nil) {
        self.type = type
        self.id = id
