...
public struct SubscriptionRelationshipsOfferCodes: Codable, JSONEncodable, Hashable {
    ...
    public init(links: AlternativeDistributionPackageVersionRelationshipsVariantsLinks? = nil, meta: PagingInformation? = nil, data: [SubscriptionOfferCodeCustomCodeRelationshipsOfferCodeData]? = nil) {
        self.links = links
        self.meta = meta
        self.data = data
    }
