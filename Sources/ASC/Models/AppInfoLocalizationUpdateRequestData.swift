...
public struct AppInfoLocalizationUpdateRequestData: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: AppInfoLocalizationUpdateRequestDataAttributes? = nil) {
        self.type = type
        self.id = id
