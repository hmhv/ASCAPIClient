...
public struct InAppPurchaseLocalization: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: InAppPurchaseLocalizationAttributes? = nil, relationships: InAppPurchaseAppStoreReviewScreenshotRelationships? = nil, links: ResourceLinks? = nil) {
        self.type = type
        self.id = id
