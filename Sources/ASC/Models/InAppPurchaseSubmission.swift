...
public struct InAppPurchaseSubmission: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, relationships: InAppPurchaseAppStoreReviewScreenshotRelationships? = nil, links: ResourceLinks? = nil) {
        self.type = type
        self.id = id
