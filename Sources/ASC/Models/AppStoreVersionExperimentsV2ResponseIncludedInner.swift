//
// AppStoreVersionExperimentsV2ResponseIncludedInner.swift
//
...
public enum AppStoreVersionExperimentsV2ResponseIncludedInner: Sendable, Codable, JSONEncodable, Hashable {
    case typeApp(App)
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let value = try? container.decode(App.self) {
            ...
            throw DecodingError.typeMismatch(Self.Type.self, .init(codingPath: decoder.codingPath, debugDescription: "Unable to decode instance of AppStoreVersionExperimentsV2ResponseIncludedInner"))
        }
    }
}
