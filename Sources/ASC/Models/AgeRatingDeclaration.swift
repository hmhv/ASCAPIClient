...
public struct AgeRatingDeclaration: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: AgeRatingDeclarationAttributes? = nil, links: ResourceLinks? = nil) {
        self.type = type
        self.id = id
