...
public struct AppInfoLocalization: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: AppInfoLocalizationAttributes? = nil, relationships: AppInfoLocalizationRelationships? = nil, links: ResourceLinks? = nil) {
        self.type = type
        self.id = id
