//
// GameCenterAchievementAttributes.swift
//
...
public struct GameCenterAchievementAttributes: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(referenceName: String? = nil, vendorIdentifier: String? = nil, points: Int? = nil, showBeforeEarned: Bool? = nil, repeatable: Bool? = nil, archived: Bool? = nil) {
