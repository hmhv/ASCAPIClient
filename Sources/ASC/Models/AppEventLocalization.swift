...
public struct AppEventLocalization: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: AppEventLocalizationAttributes? = nil, relationships: AppEventLocalizationRelationships? = nil, links: ResourceLinks? = nil) {
        self.type = type
        self.id = id
