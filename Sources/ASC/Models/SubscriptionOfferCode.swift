...
public struct SubscriptionOfferCode: Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: SubscriptionOfferCodeAttributes? = nil, relationships: SubscriptionOfferCodeRelationships? = nil, links: ResourceLinks) {
        self.type = type
        self.id = id
