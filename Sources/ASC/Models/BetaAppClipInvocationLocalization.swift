...
public struct BetaAppClipInvocationLocalization: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: BetaAppClipInvocationLocalizationAttributes? = nil, links: ResourceLinks? = nil) {
        self.type = type
        self.id = id
