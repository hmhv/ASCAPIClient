...
public struct GameCenterAchievementRelationshipsLocalizations: Codable, JSONEncodable, Hashable {
    ...
    public init(links: AlternativeDistributionPackageVersionRelationshipsVariantsLinks? = nil, meta: PagingInformation? = nil, data: [GameCenterAchievementImageRelationshipsGameCenterAchievementLocalizationData]? = nil) {
        self.links = links
        self.meta = meta
        self.data = data
    }
