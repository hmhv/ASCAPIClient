...
public struct AppEncryptionDeclarationsResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(data: [AppEncryptionDeclaration], included: [AppEncryptionDeclarationsResponseIncludedInner]? = nil, links: PagedDocumentLinks, meta: PagingInformation? = nil) {
        self.data = data
