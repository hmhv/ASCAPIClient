...
public struct AppCustomProductPageLocalizationUpdateRequestData: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: AppCustomProductPageLocalizationUpdateRequestDataAttributes? = nil) {
        self.type = type
        self.id = id
