...
public struct AppClipDefaultExperienceLocalization: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: AppClipDefaultExperienceLocalizationAttributes? = nil, relationships: AppClipDefaultExperienceLocalizationRelationships? = nil, links: ResourceLinks? = nil) {
        self.type = type
        self.id = id
