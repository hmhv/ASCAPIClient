...
public struct SubscriptionSubmission: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, relationships: SubscriptionAppStoreReviewScreenshotRelationships? = nil, links: ResourceLinks? = nil) {
        self.type = type
        self.id = id
