...
public struct SubscriptionPromotionalOffer: Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: SubscriptionPromotionalOfferAttributes? = nil, relationships: SubscriptionPromotionalOfferRelationships? = nil, links: ResourceLinks) {
        self.type = type
        self.id = id
