...
public struct AppEventVideoClipUpdateRequestData: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: AppEventVideoClipUpdateRequestDataAttributes? = nil) {
        self.type = type
        self.id = id
