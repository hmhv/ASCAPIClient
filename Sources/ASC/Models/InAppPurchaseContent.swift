...
public struct InAppPurchaseContent: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: InAppPurchaseContentAttributes? = nil, relationships: InAppPurchaseAppStoreReviewScreenshotRelationships? = nil, links: ResourceLinks? = nil) {
        self.type = type
        self.id = id
