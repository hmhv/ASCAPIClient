...
public struct SubscriptionLocalization: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: InAppPurchaseLocalizationAttributes? = nil, relationships: SubscriptionAppStoreReviewScreenshotRelationships? = nil, links: ResourceLinks? = nil) {
        self.type = type
        self.id = id
