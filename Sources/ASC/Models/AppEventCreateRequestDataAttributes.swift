...
public struct AppEventCreateRequestDataAttributes: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(referenceName: String, badge: Badge? = nil, deepLink: String? = nil, purchaseRequirement: String? = nil, primaryLocale: String? = nil, priority: Priority? = nil, purpose: Purpose? = nil, territorySchedules: [AppEventAttributesTerritorySchedulesInner]? = nil) {
