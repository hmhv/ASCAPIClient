...
public struct AppStoreVersionExperimentCreateRequestData: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, attributes: AppStoreVersionExperimentCreateRequestDataAttributes, relationships: AlternativeDistributionPackageCreateRequestDataRelationships) {
        self.type = type
