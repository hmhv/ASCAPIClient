...
public struct AppEventLocalizationUpdateRequestData: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: AppEventLocalizationUpdateRequestDataAttributes? = nil) {
        self.type = type
        self.id = id
