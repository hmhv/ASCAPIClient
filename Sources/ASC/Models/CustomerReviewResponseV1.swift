...
public struct CustomerReviewResponseV1: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: CustomerReviewResponseV1Attributes? = nil, relationships: CustomerReviewResponseV1Relationships? = nil, links: ResourceLinks? = nil) {
        self.type = type
        self.id = id
