...
public struct BetaBuildLocalizationUpdateRequestData: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: BetaBuildLocalizationUpdateRequestDataAttributes? = nil) {
        self.type = type
        self.id = id
