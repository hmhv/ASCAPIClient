...
public struct BuildBetaDetailUpdateRequestData: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: BuildBetaDetailUpdateRequestDataAttributes? = nil) {
        self.type = type
        self.id = id
