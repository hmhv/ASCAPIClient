...
public struct SubscriptionUpdateRequestData: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType, id: String, attributes: SubscriptionUpdateRequestDataAttributes? = nil, relationships: SubscriptionUpdateRequestDataRelationships? = nil) {
        self.type = type
        self.id = id
