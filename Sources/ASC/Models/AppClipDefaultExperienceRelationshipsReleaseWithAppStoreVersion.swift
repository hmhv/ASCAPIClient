...
public struct AppClipDefaultExperienceRelationshipsReleaseWithAppStoreVersion: Codable, JSONEncodable, Hashable {
    ...
    public init(links: AlternativeDistributionPackageVersionRelationshipsVariantsLinks? = nil, data: AlternativeDistributionPackageCreateRequestDataRelationshipsAppStoreVersionData? = nil) {
        self.links = links
        self.data = data
    }
