    ...
    open class func ageRatingDeclarationsUpdateInstance(id: String, ageRatingDeclarationUpdateRequest: AgeRatingDeclarationUpdateRequest) async throws -> AgeRatingDeclarationResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ageRatingDeclarationsUpdateInstanceWithRequestBuilder(id: id, ageRatingDeclarationUpdateRequest: ageRatingDeclarationUpdateRequest).execute { result in
                    switch result {
    ...
    open class func ageRatingDeclarationsUpdateInstance(urlString: String) async throws -> AgeRatingDeclarationResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ageRatingDeclarationsUpdateInstanceWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
