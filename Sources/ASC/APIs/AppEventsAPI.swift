...
open class AppEventsAPI {
    ...
    open class func appEventsCreateInstance(appEventCreateRequest: AppEventCreateRequest) async throws -> AppEventResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = appEventsCreateInstanceWithRequestBuilder(appEventCreateRequest: appEventCreateRequest).execute { result in
                    switch result {
    ...
    open class func appEventsCreateInstance(urlString: String) async throws -> AppEventResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = appEventsCreateInstanceWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func appEventsDeleteInstance(id: String) async throws {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = appEventsDeleteInstanceWithRequestBuilder(id: id).execute { result in
                    switch result {
                    case .success:
    ...
    open class func appEventsDeleteInstance(urlString: String) async throws {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = appEventsDeleteInstanceWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case .success:
                        continuation.resume(returning: ())
                    case let .failure(error):
     ...
     */
    public enum FieldsAppEvents_appEventsGetInstance: String, CaseIterable, JSONEncodable {
        case app = "app"
     ...
     */
    public enum Include_appEventsGetInstance: String, CaseIterable, JSONEncodable {
        case localizations = "localizations"
    }
     ...
     */
    public enum FieldsAppEventLocalizations_appEventsGetInstance: String, CaseIterable, JSONEncodable {
    ...
    open class func appEventsGetInstance(id: String, fieldsAppEvents: [FieldsAppEvents_appEventsGetInstance]? = nil, include: [Include_appEventsGetInstance]? = nil, fieldsAppEventLocalizations: [FieldsAppEventLocalizations_appEventsGetInstance]? = nil, limitLocalizations: Int? = nil) async throws -> AppEventResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = appEventsGetInstanceWithRequestBuilder(id: id, fieldsAppEvents: fieldsAppEvents, include: include, fieldsAppEventLocalizations: fieldsAppEventLocalizations, limitLocalizations: limitLocalizations).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func appEventsGetInstance(urlString: String) async throws -> AppEventResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = appEventsGetInstanceWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
     ...
     */
    public enum FieldsAppEventScreenshots_appEventsLocalizationsGetToManyRelated: String, CaseIterable, JSONEncodable {
     ...
     */
    public enum FieldsAppEventVideoClips_appEventsLocalizationsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case appeventassettype = "appEventAssetType"
        case appeventlocalization = "appEventLocalization"
        case assetdeliverystate = "assetDeliveryState"
        case filename = "fileName"
     ...
     * enum for parameter fieldsAppEventLocalizations
     */
    public enum FieldsAppEventLocalizations_appEventsLocalizationsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case appevent = "appEvent"
        case appeventscreenshots = "appEventScreenshots"
        case appeventvideoclips = "appEventVideoClips"
        case locale = "locale"
     ...
     * enum for parameter fieldsAppEvents
     */
    public enum FieldsAppEvents_appEventsLocalizationsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case app = "app"
        case archivedterritoryschedules = "archivedTerritorySchedules"
        case badge = "badge"
        case deeplink = "deepLink"
     ...
     * enum for parameter include
     */
    public enum Include_appEventsLocalizationsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case appevent = "appEvent"
        case appeventscreenshots = "appEventScreenshots"
        case appeventvideoclips = "appEventVideoClips"
    }
    ...
    open class func appEventsLocalizationsGetToManyRelated(id: String, fieldsAppEventScreenshots: [FieldsAppEventScreenshots_appEventsLocalizationsGetToManyRelated]? = nil, fieldsAppEventVideoClips: [FieldsAppEventVideoClips_appEventsLocalizationsGetToManyRelated]? = nil, fieldsAppEventLocalizations: [FieldsAppEventLocalizations_appEventsLocalizationsGetToManyRelated]? = nil, fieldsAppEvents: [FieldsAppEvents_appEventsLocalizationsGetToManyRelated]? = nil, limit: Int? = nil, limitAppEventScreenshots: Int? = nil, limitAppEventVideoClips: Int? = nil, include: [Include_appEventsLocalizationsGetToManyRelated]? = nil) async throws -> AppEventLocalizationsResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = appEventsLocalizationsGetToManyRelatedWithRequestBuilder(id: id, fieldsAppEventScreenshots: fieldsAppEventScreenshots, fieldsAppEventVideoClips: fieldsAppEventVideoClips, fieldsAppEventLocalizations: fieldsAppEventLocalizations, fieldsAppEvents: fieldsAppEvents, limit: limit, limitAppEventScreenshots: limitAppEventScreenshots, limitAppEventVideoClips: limitAppEventVideoClips, include: include).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func appEventsLocalizationsGetToManyRelated(urlString: String) async throws -> AppEventLocalizationsResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = appEventsLocalizationsGetToManyRelatedWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func appEventsUpdateInstance(id: String, appEventUpdateRequest: AppEventUpdateRequest) async throws -> AppEventResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = appEventsUpdateInstanceWithRequestBuilder(id: id, appEventUpdateRequest: appEventUpdateRequest).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func appEventsUpdateInstance(urlString: String) async throws -> AppEventResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = appEventsUpdateInstanceWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
