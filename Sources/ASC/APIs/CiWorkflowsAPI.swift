...
open class CiWorkflowsAPI {
     ...
     */
    public enum FieldsScmGitReferences_ciWorkflowsBuildRunsGetToManyRelated: String, CaseIterable, JSONEncodable {
     ...
     */
    public enum FieldsCiBuildRuns_ciWorkflowsBuildRunsGetToManyRelated: String, CaseIterable, JSONEncodable {
     ...
     */
    public enum FieldsCiWorkflows_ciWorkflowsBuildRunsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case actions = "actions"
     ...
     */
    public enum FieldsScmPullRequests_ciWorkflowsBuildRunsGetToManyRelated: String, CaseIterable, JSONEncodable {
     ...
     */
    public enum FieldsCiProducts_ciWorkflowsBuildRunsGetToManyRelated: String, CaseIterable, JSONEncodable {
     ...
     */
    public enum FieldsBuilds_ciWorkflowsBuildRunsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case app = "app"
     ...
     */
    public enum Include_ciWorkflowsBuildRunsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case builds = "builds"
        case destinationbranch = "destinationBranch"
        case product = "product"
        case pullrequest = "pullRequest"
    ...
    open class func ciWorkflowsBuildRunsGetToManyRelated(urlString: String) async throws -> CiBuildRunsResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciWorkflowsBuildRunsGetToManyRelatedWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func ciWorkflowsCreateInstance(ciWorkflowCreateRequest: CiWorkflowCreateRequest) async throws -> CiWorkflowResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciWorkflowsCreateInstanceWithRequestBuilder(ciWorkflowCreateRequest: ciWorkflowCreateRequest).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func ciWorkflowsCreateInstance(urlString: String) async throws -> CiWorkflowResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciWorkflowsCreateInstanceWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func ciWorkflowsDeleteInstance(id: String) async throws {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciWorkflowsDeleteInstanceWithRequestBuilder(id: id).execute { result in
                    switch result {
                    case .success:
    ...
    open class func ciWorkflowsDeleteInstance(urlString: String) async throws {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciWorkflowsDeleteInstanceWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case .success:
                        continuation.resume(returning: ())
                    case let .failure(error):
     ...
     * enum for parameter fieldsCiWorkflows
     */
    public enum FieldsCiWorkflows_ciWorkflowsGetInstance: String, CaseIterable, JSONEncodable {
        case actions = "actions"
        case branchstartcondition = "branchStartCondition"
        case buildruns = "buildRuns"
        case clean = "clean"
     ...
     * enum for parameter include
     */
    public enum Include_ciWorkflowsGetInstance: String, CaseIterable, JSONEncodable {
        case macosversion = "macOsVersion"
        case product = "product"
        case repository = "repository"
        case xcodeversion = "xcodeVersion"
     ...
     * enum for parameter fieldsCiBuildRuns
     */
    public enum FieldsCiBuildRuns_ciWorkflowsGetInstance: String, CaseIterable, JSONEncodable {
        case actions = "actions"
        case buildrun = "buildRun"
        case builds = "builds"
        case cancelreason = "cancelReason"
     ...
     */
    public enum FieldsScmRepositories_ciWorkflowsGetInstance: String, CaseIterable, JSONEncodable {
    ...
    open class func ciWorkflowsGetInstance(id: String, fieldsCiWorkflows: [FieldsCiWorkflows_ciWorkflowsGetInstance]? = nil, include: [Include_ciWorkflowsGetInstance]? = nil, fieldsCiBuildRuns: [FieldsCiBuildRuns_ciWorkflowsGetInstance]? = nil, fieldsScmRepositories: [FieldsScmRepositories_ciWorkflowsGetInstance]? = nil) async throws -> CiWorkflowResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciWorkflowsGetInstanceWithRequestBuilder(id: id, fieldsCiWorkflows: fieldsCiWorkflows, include: include, fieldsCiBuildRuns: fieldsCiBuildRuns, fieldsScmRepositories: fieldsScmRepositories).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func ciWorkflowsGetInstance(urlString: String) async throws -> CiWorkflowResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciWorkflowsGetInstanceWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
     ...
     * enum for parameter fieldsScmGitReferences
     */
    public enum FieldsScmGitReferences_ciWorkflowsRepositoryGetToOneRelated: String, CaseIterable, JSONEncodable {
        case canonicalname = "canonicalName"
        case isdeleted = "isDeleted"
        case kind = "kind"
        case name = "name"
     ...
     */
    public enum FieldsScmProviders_ciWorkflowsRepositoryGetToOneRelated: String, CaseIterable, JSONEncodable {
     ...
     * enum for parameter fieldsScmRepositories
     */
    public enum FieldsScmRepositories_ciWorkflowsRepositoryGetToOneRelated: String, CaseIterable, JSONEncodable {
        case defaultbranch = "defaultBranch"
        case gitreferences = "gitReferences"
        case httpcloneurl = "httpCloneUrl"
        case lastaccesseddate = "lastAccessedDate"
     ...
     * enum for parameter include
     */
    public enum Include_ciWorkflowsRepositoryGetToOneRelated: String, CaseIterable, JSONEncodable {
        case defaultbranch = "defaultBranch"
        case scmprovider = "scmProvider"
    }
    ...
    open class func ciWorkflowsRepositoryGetToOneRelated(id: String, fieldsScmGitReferences: [FieldsScmGitReferences_ciWorkflowsRepositoryGetToOneRelated]? = nil, fieldsScmProviders: [FieldsScmProviders_ciWorkflowsRepositoryGetToOneRelated]? = nil, fieldsScmRepositories: [FieldsScmRepositories_ciWorkflowsRepositoryGetToOneRelated]? = nil, include: [Include_ciWorkflowsRepositoryGetToOneRelated]? = nil) async throws -> ScmRepositoryResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciWorkflowsRepositoryGetToOneRelatedWithRequestBuilder(id: id, fieldsScmGitReferences: fieldsScmGitReferences, fieldsScmProviders: fieldsScmProviders, fieldsScmRepositories: fieldsScmRepositories, include: include).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func ciWorkflowsRepositoryGetToOneRelated(urlString: String) async throws -> ScmRepositoryResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciWorkflowsRepositoryGetToOneRelatedWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func ciWorkflowsUpdateInstance(id: String, ciWorkflowUpdateRequest: CiWorkflowUpdateRequest) async throws -> CiWorkflowResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciWorkflowsUpdateInstanceWithRequestBuilder(id: id, ciWorkflowUpdateRequest: ciWorkflowUpdateRequest).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func ciWorkflowsUpdateInstance(urlString: String) async throws -> CiWorkflowResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciWorkflowsUpdateInstanceWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
