...
open class InAppPurchaseContentsAPI {
     ...
     */
    public enum FieldsInAppPurchaseContents_inAppPurchaseContentsGetInstance: String, CaseIterable, JSONEncodable {
     ...
     */
    public enum Include_inAppPurchaseContentsGetInstance: String, CaseIterable, JSONEncodable {
        case inapppurchasev2 = "inAppPurchaseV2"
    }
    ...
    open class func inAppPurchaseContentsGetInstance(id: String, fieldsInAppPurchaseContents: [FieldsInAppPurchaseContents_inAppPurchaseContentsGetInstance]? = nil, include: [Include_inAppPurchaseContentsGetInstance]? = nil) async throws -> InAppPurchaseContentResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = inAppPurchaseContentsGetInstanceWithRequestBuilder(id: id, fieldsInAppPurchaseContents: fieldsInAppPurchaseContents, include: include).execute { result in
                    switch result {
    ...
    open class func inAppPurchaseContentsGetInstance(urlString: String) async throws -> InAppPurchaseContentResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = inAppPurchaseContentsGetInstanceWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
