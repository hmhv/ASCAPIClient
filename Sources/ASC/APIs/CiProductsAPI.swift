...
open class CiProductsAPI {
     ...
     */
    public enum FieldsScmGitReferences_ciProductsAdditionalRepositoriesGetToManyRelated: String, CaseIterable, JSONEncodable {
     ...
     */
    public enum FieldsScmProviders_ciProductsAdditionalRepositoriesGetToManyRelated: String, CaseIterable, JSONEncodable {
     ...
     */
    public enum FieldsScmRepositories_ciProductsAdditionalRepositoriesGetToManyRelated: String, CaseIterable, JSONEncodable {
     ...
     */
    public enum Include_ciProductsAdditionalRepositoriesGetToManyRelated: String, CaseIterable, JSONEncodable {
        case defaultbranch = "defaultBranch"
        case scmprovider = "scmProvider"
    }
    ...
    open class func ciProductsAdditionalRepositoriesGetToManyRelated(id: String, filterId: [String]? = nil, fieldsScmGitReferences: [FieldsScmGitReferences_ciProductsAdditionalRepositoriesGetToManyRelated]? = nil, fieldsScmProviders: [FieldsScmProviders_ciProductsAdditionalRepositoriesGetToManyRelated]? = nil, fieldsScmRepositories: [FieldsScmRepositories_ciProductsAdditionalRepositoriesGetToManyRelated]? = nil, limit: Int? = nil, include: [Include_ciProductsAdditionalRepositoriesGetToManyRelated]? = nil) async throws -> ScmRepositoriesResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciProductsAdditionalRepositoriesGetToManyRelatedWithRequestBuilder(id: id, filterId: filterId, fieldsScmGitReferences: fieldsScmGitReferences, fieldsScmProviders: fieldsScmProviders, fieldsScmRepositories: fieldsScmRepositories, limit: limit, include: include).execute { result in
                    switch result {
    ...
    open class func ciProductsAdditionalRepositoriesGetToManyRelated(urlString: String) async throws -> ScmRepositoriesResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciProductsAdditionalRepositoriesGetToManyRelatedWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
     ...
     */
    public enum FieldsBetaLicenseAgreements_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
     ...
     */
    public enum FieldsBetaAppReviewDetails_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
        case app = "app"
     ...
     */
    public enum FieldsAppClips_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
        case app = "app"
     ...
     */
    public enum FieldsBetaAppLocalizations_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
        case app = "app"
     ...
     */
    public enum FieldsAppInfos_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
     ...
     */
    public enum FieldsPreReleaseVersions_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
        case app = "app"
        case builds = "builds"
     ...
     */
    public enum FieldsReviewSubmissions_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
        case app = "app"
     ...
     */
    public enum FieldsBetaGroups_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
        case app = "app"
     ...
     */
    public enum FieldsAppPreOrders_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
        case app = "app"
     ...
     */
    public enum FieldsAppPrices_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
        case app = "app"
     ...
     */
    public enum FieldsGameCenterEnabledVersions_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
        case app = "app"
     ...
     */
    public enum FieldsAppStoreVersions_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
        case ageratingdeclaration = "ageRatingDeclaration"
        case app = "app"
     ...
     */
    public enum FieldsAppCustomProductPages_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
        case app = "app"
     ...
     */
    public enum FieldsApps_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
     ...
     */
    public enum FieldsAppEvents_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
        case app = "app"
     ...
     */
    public enum FieldsTerritories_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
     ...
     */
    public enum FieldsBuilds_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
        case app = "app"
     ...
     * enum for parameter include
     */
    public enum Include_ciProductsAppGetToOneRelated: String, CaseIterable, JSONEncodable {
        case appclips = "appClips"
        case appcustomproductpages = "appCustomProductPages"
        case appevents = "appEvents"
        case appinfos = "appInfos"
    ...
    open class func ciProductsAppGetToOneRelated(urlString: String) async throws -> AppResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciProductsAppGetToOneRelatedWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
     ...
     * enum for parameter fieldsScmGitReferences
     */
    public enum FieldsScmGitReferences_ciProductsBuildRunsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case canonicalname = "canonicalName"
        case isdeleted = "isDeleted"
        case kind = "kind"
        case name = "name"
     ...
     */
    public enum FieldsCiBuildRuns_ciProductsBuildRunsGetToManyRelated: String, CaseIterable, JSONEncodable {
     ...
     */
    public enum FieldsCiWorkflows_ciProductsBuildRunsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case actions = "actions"
     ...
     */
    public enum FieldsScmPullRequests_ciProductsBuildRunsGetToManyRelated: String, CaseIterable, JSONEncodable {
     ...
     * enum for parameter fieldsCiProducts
     */
    public enum FieldsCiProducts_ciProductsBuildRunsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case additionalrepositories = "additionalRepositories"
        case app = "app"
        case buildruns = "buildRuns"
        case bundleid = "bundleId"
     ...
     * enum for parameter fieldsBuilds
     */
    public enum FieldsBuilds_ciProductsBuildRunsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case app = "app"
        case appencryptiondeclaration = "appEncryptionDeclaration"
        case appstoreversion = "appStoreVersion"
        case betaappreviewsubmission = "betaAppReviewSubmission"
     ...
     * enum for parameter include
     */
    public enum Include_ciProductsBuildRunsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case builds = "builds"
        case destinationbranch = "destinationBranch"
        case product = "product"
        case pullrequest = "pullRequest"
    ...
    open class func ciProductsBuildRunsGetToManyRelated(urlString: String) async throws -> CiBuildRunsResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciProductsBuildRunsGetToManyRelatedWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func ciProductsDeleteInstance(id: String) async throws {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciProductsDeleteInstanceWithRequestBuilder(id: id).execute { result in
                    switch result {
                    case .success:
    ...
    open class func ciProductsDeleteInstance(urlString: String) async throws {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciProductsDeleteInstanceWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case .success:
                        continuation.resume(returning: ())
                    case let .failure(error):
     ...
     */
    public enum FilterProductType_ciProductsGetCollection: String, CaseIterable, JSONEncodable {
        case app = "APP"
     ...
     * enum for parameter fieldsCiProducts
     */
    public enum FieldsCiProducts_ciProductsGetCollection: String, CaseIterable, JSONEncodable {
        case additionalrepositories = "additionalRepositories"
        case app = "app"
        case buildruns = "buildRuns"
        case bundleid = "bundleId"
     ...
     * enum for parameter include
     */
    public enum Include_ciProductsGetCollection: String, CaseIterable, JSONEncodable {
        case app = "app"
        case bundleid = "bundleId"
        case primaryrepositories = "primaryRepositories"
    }
     ...
     * enum for parameter fieldsCiBuildRuns
     */
    public enum FieldsCiBuildRuns_ciProductsGetCollection: String, CaseIterable, JSONEncodable {
        case actions = "actions"
        case buildrun = "buildRun"
        case builds = "builds"
        case cancelreason = "cancelReason"
     ...
     * enum for parameter fieldsCiWorkflows
     */
    public enum FieldsCiWorkflows_ciProductsGetCollection: String, CaseIterable, JSONEncodable {
        case actions = "actions"
        case branchstartcondition = "branchStartCondition"
        case buildruns = "buildRuns"
        case clean = "clean"
     ...
     * enum for parameter fieldsApps
     */
    public enum FieldsApps_ciProductsGetCollection: String, CaseIterable, JSONEncodable {
        case appclips = "appClips"
        case appcustomproductpages = "appCustomProductPages"
        case appevents = "appEvents"
        case appinfos = "appInfos"
     ...
     * enum for parameter fieldsScmRepositories
     */
    public enum FieldsScmRepositories_ciProductsGetCollection: String, CaseIterable, JSONEncodable {
        case defaultbranch = "defaultBranch"
        case gitreferences = "gitReferences"
        case httpcloneurl = "httpCloneUrl"
        case lastaccesseddate = "lastAccessedDate"
    ...
    open class func ciProductsGetCollection(urlString: String) async throws -> CiProductsResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciProductsGetCollectionWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func ciProductsGetCollectionWithRequestBuilder(filterProductType: [FilterProductType_ciProductsGetCollection]? = nil, filterApp: [String]? = nil, fieldsCiProducts: [FieldsCiProducts_ciProductsGetCollection]? = nil, limit: Int? = nil, include: [Include_ciProductsGetCollection]? = nil, fieldsCiBuildRuns: [FieldsCiBuildRuns_ciProductsGetCollection]? = nil, fieldsCiWorkflows: [FieldsCiWorkflows_ciProductsGetCollection]? = nil, fieldsApps: [FieldsApps_ciProductsGetCollection]? = nil, fieldsScmRepositories: [FieldsScmRepositories_ciProductsGetCollection]? = nil, limitPrimaryRepositories: Int? = nil) -> RequestBuilder<CiProductsResponse> {
        ...
        var localVariableUrlComponents = URLComponents(string: localVariableURLString)
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            "filter[productType]": filterProductType?.encodeToJSON(),
     ...
     * enum for parameter fieldsCiProducts
     */
    public enum FieldsCiProducts_ciProductsGetInstance: String, CaseIterable, JSONEncodable {
        case additionalrepositories = "additionalRepositories"
        case app = "app"
        case buildruns = "buildRuns"
        case bundleid = "bundleId"
     ...
     * enum for parameter include
     */
    public enum Include_ciProductsGetInstance: String, CaseIterable, JSONEncodable {
        case app = "app"
        case bundleid = "bundleId"
        case primaryrepositories = "primaryRepositories"
    }
     ...
     * enum for parameter fieldsCiBuildRuns
     */
    public enum FieldsCiBuildRuns_ciProductsGetInstance: String, CaseIterable, JSONEncodable {
        case actions = "actions"
        case buildrun = "buildRun"
        case builds = "builds"
        case cancelreason = "cancelReason"
     ...
     * enum for parameter fieldsCiWorkflows
     */
    public enum FieldsCiWorkflows_ciProductsGetInstance: String, CaseIterable, JSONEncodable {
        case actions = "actions"
        case branchstartcondition = "branchStartCondition"
        case buildruns = "buildRuns"
        case clean = "clean"
     ...
     * enum for parameter fieldsApps
     */
    public enum FieldsApps_ciProductsGetInstance: String, CaseIterable, JSONEncodable {
        case appclips = "appClips"
        case appcustomproductpages = "appCustomProductPages"
        case appevents = "appEvents"
        case appinfos = "appInfos"
     ...
     * enum for parameter fieldsScmRepositories
     */
    public enum FieldsScmRepositories_ciProductsGetInstance: String, CaseIterable, JSONEncodable {
        case defaultbranch = "defaultBranch"
        case gitreferences = "gitReferences"
        case httpcloneurl = "httpCloneUrl"
        case lastaccesseddate = "lastAccessedDate"
    ...
    open class func ciProductsGetInstance(id: String, fieldsCiProducts: [FieldsCiProducts_ciProductsGetInstance]? = nil, include: [Include_ciProductsGetInstance]? = nil, fieldsCiBuildRuns: [FieldsCiBuildRuns_ciProductsGetInstance]? = nil, fieldsCiWorkflows: [FieldsCiWorkflows_ciProductsGetInstance]? = nil, fieldsApps: [FieldsApps_ciProductsGetInstance]? = nil, fieldsScmRepositories: [FieldsScmRepositories_ciProductsGetInstance]? = nil, limitPrimaryRepositories: Int? = nil) async throws -> CiProductResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciProductsGetInstanceWithRequestBuilder(id: id, fieldsCiProducts: fieldsCiProducts, include: include, fieldsCiBuildRuns: fieldsCiBuildRuns, fieldsCiWorkflows: fieldsCiWorkflows, fieldsApps: fieldsApps, fieldsScmRepositories: fieldsScmRepositories, limitPrimaryRepositories: limitPrimaryRepositories).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func ciProductsGetInstance(urlString: String) async throws -> CiProductResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciProductsGetInstanceWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
     ...
     * enum for parameter fieldsScmGitReferences
     */
    public enum FieldsScmGitReferences_ciProductsPrimaryRepositoriesGetToManyRelated: String, CaseIterable, JSONEncodable {
        case canonicalname = "canonicalName"
        case isdeleted = "isDeleted"
        case kind = "kind"
        case name = "name"
     ...
     * enum for parameter fieldsScmProviders
     */
    public enum FieldsScmProviders_ciProductsPrimaryRepositoriesGetToManyRelated: String, CaseIterable, JSONEncodable {
        case repositories = "repositories"
        case scmprovidertype = "scmProviderType"
        case url = "url"
    }
     ...
     * enum for parameter fieldsScmRepositories
     */
    public enum FieldsScmRepositories_ciProductsPrimaryRepositoriesGetToManyRelated: String, CaseIterable, JSONEncodable {
        case defaultbranch = "defaultBranch"
        case gitreferences = "gitReferences"
        case httpcloneurl = "httpCloneUrl"
        case lastaccesseddate = "lastAccessedDate"
     ...
     * enum for parameter include
     */
    public enum Include_ciProductsPrimaryRepositoriesGetToManyRelated: String, CaseIterable, JSONEncodable {
        case defaultbranch = "defaultBranch"
        case scmprovider = "scmProvider"
    }
    ...
    open class func ciProductsPrimaryRepositoriesGetToManyRelated(id: String, filterId: [String]? = nil, fieldsScmGitReferences: [FieldsScmGitReferences_ciProductsPrimaryRepositoriesGetToManyRelated]? = nil, fieldsScmProviders: [FieldsScmProviders_ciProductsPrimaryRepositoriesGetToManyRelated]? = nil, fieldsScmRepositories: [FieldsScmRepositories_ciProductsPrimaryRepositoriesGetToManyRelated]? = nil, limit: Int? = nil, include: [Include_ciProductsPrimaryRepositoriesGetToManyRelated]? = nil) async throws -> ScmRepositoriesResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciProductsPrimaryRepositoriesGetToManyRelatedWithRequestBuilder(id: id, filterId: filterId, fieldsScmGitReferences: fieldsScmGitReferences, fieldsScmProviders: fieldsScmProviders, fieldsScmRepositories: fieldsScmRepositories, limit: limit, include: include).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func ciProductsPrimaryRepositoriesGetToManyRelated(urlString: String) async throws -> ScmRepositoriesResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciProductsPrimaryRepositoriesGetToManyRelatedWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
     ...
     */
    public enum FieldsCiXcodeVersions_ciProductsWorkflowsGetToManyRelated: String, CaseIterable, JSONEncodable {
     ...
     * enum for parameter fieldsCiWorkflows
     */
    public enum FieldsCiWorkflows_ciProductsWorkflowsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case actions = "actions"
        case branchstartcondition = "branchStartCondition"
        case buildruns = "buildRuns"
        case clean = "clean"
     ...
     */
    public enum FieldsCiMacOsVersions_ciProductsWorkflowsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case name = "name"
        case version = "version"
     ...
     * enum for parameter fieldsCiProducts
     */
    public enum FieldsCiProducts_ciProductsWorkflowsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case additionalrepositories = "additionalRepositories"
        case app = "app"
        case buildruns = "buildRuns"
        case bundleid = "bundleId"
     ...
     * enum for parameter fieldsScmRepositories
     */
    public enum FieldsScmRepositories_ciProductsWorkflowsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case defaultbranch = "defaultBranch"
        case gitreferences = "gitReferences"
        case httpcloneurl = "httpCloneUrl"
        case lastaccesseddate = "lastAccessedDate"
     ...
     * enum for parameter include
     */
    public enum Include_ciProductsWorkflowsGetToManyRelated: String, CaseIterable, JSONEncodable {
        case macosversion = "macOsVersion"
        case product = "product"
        case repository = "repository"
        case xcodeversion = "xcodeVersion"
    ...
    open class func ciProductsWorkflowsGetToManyRelated(id: String, fieldsCiXcodeVersions: [FieldsCiXcodeVersions_ciProductsWorkflowsGetToManyRelated]? = nil, fieldsCiWorkflows: [FieldsCiWorkflows_ciProductsWorkflowsGetToManyRelated]? = nil, fieldsCiMacOsVersions: [FieldsCiMacOsVersions_ciProductsWorkflowsGetToManyRelated]? = nil, fieldsCiProducts: [FieldsCiProducts_ciProductsWorkflowsGetToManyRelated]? = nil, fieldsScmRepositories: [FieldsScmRepositories_ciProductsWorkflowsGetToManyRelated]? = nil, limit: Int? = nil, include: [Include_ciProductsWorkflowsGetToManyRelated]? = nil) async throws -> CiWorkflowsResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciProductsWorkflowsGetToManyRelatedWithRequestBuilder(id: id, fieldsCiXcodeVersions: fieldsCiXcodeVersions, fieldsCiWorkflows: fieldsCiWorkflows, fieldsCiMacOsVersions: fieldsCiMacOsVersions, fieldsCiProducts: fieldsCiProducts, fieldsScmRepositories: fieldsScmRepositories, limit: limit, include: include).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
    ...
    open class func ciProductsWorkflowsGetToManyRelated(urlString: String) async throws -> CiWorkflowsResponse {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                requestTask = ciProductsWorkflowsGetToManyRelatedWithRequestBuilder(urlString: urlString).execute { result in
                    switch result {
                    case let .success(response):
                        continuation.resume(returning: response.body)
                    case let .failure(error):
