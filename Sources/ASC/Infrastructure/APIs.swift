...
open class ASCAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://api.appstoreconnect.apple.com",
    ...
    public static let shared = ASCAPIConfiguration()
}
...
open class RequestBuilder<T>: @unchecked Sendable {
    ...
    public let apiConfiguration: ASCAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: Any]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: ASCAPIConfiguration = ASCAPIConfiguration.shared) {
        self.method = method
