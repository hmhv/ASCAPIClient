...
let betaTesterAppsLinkagesRequest = BetaTesterAppsLinkagesRequest(data: [AppClip_relationships_app_data(type: "type_example", id: "id_example")]) // BetaTesterAppsLinkagesRequest | List of related linkages
...
```swift
    open class func betaTestersAppsGetToManyRelated(id: String, fieldsApps: [FieldsApps_betaTestersAppsGetToManyRelated]? = nil, limit: Int? = nil, completion: @escaping (_ data: AppsResponse?, _ error: Error?) -> Void)
```
...
```swift
    open class func betaTestersBetaGroupsGetToManyRelated(id: String, fieldsBetaGroups: [FieldsBetaGroups_betaTestersBetaGroupsGetToManyRelated]? = nil, limit: Int? = nil, completion: @escaping (_ data: BetaGroupsResponse?, _ error: Error?) -> Void)
```
...
let id = "id_example" // String | the id of the requested resource
let betaTesterBuildsLinkagesRequest = BetaTesterBuildsLinkagesRequest(data: [AppStoreVersion_relationships_build_data(type: "type_example", id: "id_example")]) // BetaTesterBuildsLinkagesRequest | List of related linkages
...
```swift
    open class func betaTestersBuildsGetToManyRelated(id: String, fieldsBuilds: [FieldsBuilds_betaTestersBuildsGetToManyRelated]? = nil, limit: Int? = nil, completion: @escaping (_ data: BuildsResponse?, _ error: Error?) -> Void)
```
