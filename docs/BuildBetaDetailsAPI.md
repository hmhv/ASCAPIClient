...
```swift
    open class func buildBetaDetailsBuildGetToOneRelated(id: String, fieldsBuilds: [FieldsBuilds_buildBetaDetailsBuildGetToOneRelated]? = nil, completion: @escaping (_ data: BuildResponse?, _ error: Error?) -> Void)
```
