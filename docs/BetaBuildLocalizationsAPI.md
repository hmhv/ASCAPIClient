...
```swift
    open class func betaBuildLocalizationsBuildGetToOneRelated(id: String, fieldsBuilds: [FieldsBuilds_betaBuildLocalizationsBuildGetToOneRelated]? = nil, completion: @escaping (_ data: BuildResponse?, _ error: Error?) -> Void)
```
