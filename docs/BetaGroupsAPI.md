...
```swift
    open class func betaGroupsAppGetToOneRelated(id: String, fieldsApps: [FieldsApps_betaGroupsAppGetToOneRelated]? = nil, completion: @escaping (_ data: AppResponse?, _ error: Error?) -> Void)
```
...
```swift
    open class func betaGroupsBetaTestersGetToManyRelated(id: String, fieldsBetaTesters: [FieldsBetaTesters_betaGroupsBetaTestersGetToManyRelated]? = nil, limit: Int? = nil, completion: @escaping (_ data: BetaTestersResponse?, _ error: Error?) -> Void)
```
...
let id = "id_example" // String | the id of the requested resource
let betaGroupBuildsLinkagesRequest = BetaGroupBuildsLinkagesRequest(data: [AppStoreVersion_relationships_build_data(type: "type_example", id: "id_example")]) // BetaGroupBuildsLinkagesRequest | List of related linkages
...
```swift
    open class func betaGroupsBuildsGetToManyRelated(id: String, fieldsBuilds: [FieldsBuilds_betaGroupsBuildsGetToManyRelated]? = nil, limit: Int? = nil, completion: @escaping (_ data: BuildsResponse?, _ error: Error?) -> Void)
```
