...
```swift
    open class func betaAppReviewSubmissionsBuildGetToOneRelated(id: String, fieldsBuilds: [FieldsBuilds_betaAppReviewSubmissionsBuildGetToOneRelated]? = nil, completion: @escaping (_ data: BuildResponse?, _ error: Error?) -> Void)
```
