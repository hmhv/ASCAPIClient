...
```swift
    open class func bundleIdsAppGetToOneRelated(id: String, fieldsApps: [FieldsApps_bundleIdsAppGetToOneRelated]? = nil, completion: @escaping (_ data: AppResponse?, _ error: Error?) -> Void)
```
...
```swift
    open class func bundleIdsBundleIdCapabilitiesGetToManyRelated(id: String, fieldsBundleIdCapabilities: [FieldsBundleIdCapabilities_bundleIdsBundleIdCapabilitiesGetToManyRelated]? = nil, limit: Int? = nil, completion: @escaping (_ data: BundleIdCapabilitiesResponse?, _ error: Error?) -> Void)
```
...
```swift
    open class func bundleIdsProfilesGetToManyRelated(id: String, fieldsProfiles: [FieldsProfiles_bundleIdsProfilesGetToManyRelated]? = nil, limit: Int? = nil, completion: @escaping (_ data: ProfilesResponse?, _ error: Error?) -> Void)
```
