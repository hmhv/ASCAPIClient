...
```swift
    open class func profilesBundleIdGetToOneRelated(id: String, fieldsBundleIds: [FieldsBundleIds_profilesBundleIdGetToOneRelated]? = nil, completion: @escaping (_ data: BundleIdResponse?, _ error: Error?) -> Void)
```
...
```swift
    open class func profilesCertificatesGetToManyRelated(id: String, fieldsCertificates: [FieldsCertificates_profilesCertificatesGetToManyRelated]? = nil, limit: Int? = nil, completion: @escaping (_ data: CertificatesResponse?, _ error: Error?) -> Void)
```
...
```swift
    open class func profilesDevicesGetToManyRelated(id: String, fieldsDevices: [FieldsDevices_profilesDevicesGetToManyRelated]? = nil, limit: Int? = nil, completion: @escaping (_ data: DevicesResponse?, _ error: Error?) -> Void)
```
